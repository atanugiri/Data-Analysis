...
% Bayesian analysis of initial task (before alcohol)
...
P2Adata = lightIntensityData(lightIntensityData.tasktypedone == 'P2A' & ...
    lightIntensityData.lightlevel == 1, :);
...
& lightIntensityData.intensityofcost1 == 15 & lightIntensityData.intensityofcost3 == 320, :);
...
title('Bayssian Analysis of Approach Rate at 15 lux: Initial task');
legend('Female', '', 'Male', '');
