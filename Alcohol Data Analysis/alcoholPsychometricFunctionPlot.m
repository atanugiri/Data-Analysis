% Author: Atanu Giri
% Date: 04/19/2023
% This function generate psychometric function plot for the last session of 
% a specific tasktypedone according to the input argument for alcohol data
...
function featureForEachSubjectId = alcoholPsychometricFunctionPlot(feature,varargin)
% feature = 'distanceaftertoneuntillimitingtimestamp';
close all; clc;
...
% save figure
fig_name = sprintf('%s_%s_%s',genotype,taskType,string(healthType));
